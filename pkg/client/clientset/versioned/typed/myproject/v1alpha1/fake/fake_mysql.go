...
var mysqlsResource = schema.GroupVersionResource{Group: "myproject", Version: "v1alpha1", Resource: "mysqls"}

var mysqlsKind = schema.GroupVersionKind{Group: "myproject", Version: "v1alpha1", Kind: "MySql"}
